 ...
 ******************************************************************************/
#define MAX_SPI_JOYSTICK_QUEUE			10
#define SPI_JOYSTICK_REFRESH_PERIOD	100
...
/**
 * @brief create a new joystick structure
 * @return ID for a new joystick, will return -1 if it couldn't create new joystick;
 */
